              ...
              <section class="page-aside-section">
                ...
                <div class="list-group calendar-list">
                  <a class="list-group-item calendar-event" data-title="Meeting" data-stick=true
                    ...
                    <i class="wb-medium-point red-600 mr-10" aria-hidden="true"></i>Meeting
                  </a>
                  <a class="list-group-item calendar-event" data-title="Birthday Party" data-stick=true
                    ...
                    <i class="wb-medium-point green-600 mr-10" aria-hidden="true"></i>Birthday Party
                  </a>
                  <a class="list-group-item calendar-event" data-title="Call Jimba" data-stick=true
                    data-color="orange-600" href="javascript:void(0)">
                    <i class="wb-medium-point orange-600 mr-10" aria-hidden="true"></i>Call Jimba
                  </a>
                  <a class="list-group-item calendar-event" data-title="Dinner with Team" data-stick=true
                    ...
                    <i class="wb-medium-point cyan-600 mr-10" aria-hidden="true"></i>Dinner with Team
                  </a>
                  <a id="addNewEventBtn" class="list-group-item" href="javascript:void(0)"> <i class="icon wb-plus" aria-hidden="true"></i> Add New Event </a>
                </div>
              </section>
            </div>
          </div>
